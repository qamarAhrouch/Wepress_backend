...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="filter-container">
        <h2>Filter Approved Announcements</h2>
        <form method="GET" action="{{ route('annonceapproved') }}">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('annonceapproved') }}" class="reset-button">Reset</a>
            </div>
        </form>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @if ($annonces->isEmpty())
                <tr>
                    <td colspan="6" style="text-align: center;">No approved announcements available.</td>
                </tr>
            @else
